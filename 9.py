...
def main():
    parser = argparse.ArgumentParser(description='A tool to crack WEP or WPA/WPA2 passphrases.')
    ...
    if args.wordlist:
        if not args.essid:
            print("Please specify the SSID of the target AP (option -e).")
            return
        ...
        print("Processing WEP packets, could take a while")
        try:
